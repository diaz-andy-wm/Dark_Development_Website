...
<div class="content">
    ...
    <div class="yourPosts">
        <div class="yourPostedPics">
            <h3 style="color: darkred; font-weight: bold;">Pictures</h3>
        ...
        <div class="yourPostedVids">
            <h3 style="color: darkred; font-weight: bold;">Videos</h3>
    ...
    <div class="makePost">
        <div class="postOptions">
            <h1 style="color: darkred; font-weight: bold;">Post Something!</h1>
            <div class="upSign"><h2>Upload</h2></div>
            <div class="plusSign"><h2>Make Album</h2></div>
            <div class="shareSign"><h2>Share</h2></div>
        </div>
        <div class="subs">
            <h1 style="color: darkred; font-weight: bold;">Subscriptions</h1>
            ...
            <div class="profileSub">
                <img src="https://d13yacurqjgara.cloudfront.net/users/124355/screenshots/2199042/profile_1x.png" style="width:70px; height: 70px"><br>
                <p>GavinIsLessBomb</p>
            </div>
        </div>
    </div>
    ...
    <div class="profileInfo">
        ...
        <form class="accountInfo">
            <h3 style="color: darkred; font-weight: bold;">Profile Information</h3>
            First Name: Mollee
            <br>
            Last Name: Marquez
            <br>
